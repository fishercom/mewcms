...
import { deleteProfile, getProfiles } from '@/services/profiles';
...
export default function Index() {
    const { items } = usePage<{ items: Pagination<Profile> }>().props;
            ...
            <div className="relative overflow-hidden">
                <div className="flex flex-col items-center justify-between space-y-3 pb-4 md:flex-row md:space-y-0 md:space-x-4">
                    ...
                    <div className="flex w-full justify-end md:w-auto">
                        <Button
                            onClick={() => router.visit('/admin/profiles/create')}
                                    ...
                                    <tr key={item.id} className="border-b dark:border-gray-700">
                                        ...
                                        <td className="flex items-center justify-end gap-2 px-4 py-3">
                                            <Button
                                                ...
                                                onClick={() => router.visit(route('profiles.edit', item.id))}
                                            >
                                            ...
                                            <Button
                                                ...
                                                onClick={() => deleteProfileHandler(item.id)}
                                            >
