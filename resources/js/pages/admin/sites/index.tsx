...
import { CmsSite } from '@/types/models/cms-site';
...
export default function Index() {
    ...
    const { items } = usePage<{ items: Pagination<CmsSite> }>().props;
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent className="w-56" align="end">
                                            <DropdownMenuItem asChild>
                                                <Button className="block w-full" onClick={() => router.visit(route('sites.edit', item.id))} variant="ghost">
                                                    Edit
                                                </Button>
                                            </DropdownMenuItem>                                            <DropdownMenuItem asChild>
                                                <Button className="block w-full" onClick={()=>deleteSiteHandler(item.id)} variant="ghost">
                                                    Delete
                                                </Button>
