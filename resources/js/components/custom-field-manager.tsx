        ...
        <div className="space-y-5">
            ...
            <div className="space-y-4">
                {fields.map((field, index) => (
                    <div 
                        key={index} 
                        className="bg-zinc-50/40 dark:bg-zinc-900/15 border border-zinc-200 dark:border-zinc-800/80 rounded-xl p-4 space-y-3 relative hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors"
                    >
